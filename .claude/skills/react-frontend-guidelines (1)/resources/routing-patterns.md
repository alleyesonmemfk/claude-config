...
export const Navigation: FC = () => {
  ...
  const handleReplace = () => {
    navigate('/home', { replace: true }); // Does not add to history
  };
  ...
  return (
    <nav>
      ...
      <button onClick={handleGoToLearning}>Start Learning</button>
...
export const RequireAuth: FC<RequireAuthProps> = ({ children, roles }) => {
  ...
  if (!user) {
    // Redirect to login, saving current URL
